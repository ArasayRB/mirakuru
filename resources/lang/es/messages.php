...
return [
  ...
  "Amount"=>"Precio",
  "An item with the same key is in data base."=>"Un registro con la misma llave se encuentra ya en base de datos.",
  "API Token"=> "Token API",
  ...
  "Country"=>"País",
  "Could be awsome if you want leave a comment about your last visit clicking below!"=>"Sería increíble si usted compartiera un comentario acerca de su última visita haciendo click en el botón que ve debajo de este mensage!",
  "Create"=> "Crear",
  ...
  "Home"=>"Inicio",
  "Hostal"=>"Hostal",
  "Hosters Atention"=>"Atención de Anfitriones",
  "Hostals"=>"Hostales",
  ...
  "If you dont have a reservation finished with us, please you do not need do any thing with this email"=>"Si no ha finalizado una reserva con nosotros, no necesita hacer nada con este correo electrónico",
  "Image"=>"Imagen",
  ...
  "None added yet"=>"Nada añadido aún",
  ...
  "Our house offers you quality services with fresh and totally natural products."=>"Nuestra casa pone a su disposición servicios de calidad con productos frescos y totalmente naturales.",
  "Operation"=>"Operación",
  ...
  "Save"=> "Guardar",
  "Saved."=> "Guardado.",
  "See More Comments"=>"Ver Más Comentarios",
  ...
  "The post translation has been successfully modified"=>"La traducción del post ha sido actualizada satisfactoriamnte",
  ...
  "Video"=>"Video",
  "Warning!"=>"Atención!",
  "We hope your days was you spended in our hostal magnificent very well. Can you share with other travelers your experience with our service? If you want  leave a review our hostal click in the below button please, we be greatfull of count with your opinion. Be WELCOME ALLWAYS!!"=>"Esperamos que hayan pasado muy bien sus días en nuestro magnífico hostal. ¿Puedes compartir con otros viajeros tu experiencia con nuestro servicio? Si desea dejar un comentario sobre nuestro hostal, haga clic en el botón de abajo, estaremos encantados de contar con su opinión. Sea BIENVENIDO SIEMPRE !!",
  ...
  "We provide you with several excursions, from included in your reservation price to others with an additional price, in different languages where you will know various attractions of the city."=>"Le proporcionamos a usted varias excursiones, desde incluidas en su precio de reserva hasta otras con precio adicional, en diferentes idiomas donde conocerán varios atractivos de la ciudad.",
  ...
  "Wherever you plan to go, we can help you manage your transfer from low prices to more specialized prices depending on the comfort and safety with which you like to travel."=>"Donde quiera que usted piense ir nosotros podremos ayudar a gestionar su traslado desde precios económicos hasta precios más especializados dependiendo del confort y seguridad con el que guste viajar.",
  ...
  "You are in Preview Post, the navbar no function, this is only for check how look before publish it"=>"Estás en Vista previa del Post, la barra de menú no funciona, esto es solo para que vea como luce antes de publicarlo",
