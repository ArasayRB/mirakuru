  ...
  <div class="collapse navbar-collapse" id="uno">
    @if (isset($preview))
      <ul class="navbar-nav">
       ...
       <li class="nav-item"><a href="#" class="nav-link text-light">{{__('About us')}}</a></li>
       <li class="nav-item"><a href="#" class="nav-link text-light">{{__('Services')}}</a></li>
       <li class="nav-item" id="blog-menu"><a href="#" class="nav-link text-light">{{__('Blog')}}</a></li>
       <li class="nav-item"><a href="#" class="nav-link text-light">{{__('Galery')}}</a></li>
       <li class="nav-item"><a href="#" class="nav-link text-light">{{__('Contact')}}</a></li>

       @guest
           <li class="nav-item">
               <a class="nav-link text-light" href="#" title="Go Home to Login/Vaya a Inicio para entrar">{{ __('Login') }}</a>
           </li>


           @if (Route::has('register'))
               <li class="nav-item">
                   <a class="nav-link text-light" href="#" title="Go Home to Register/Vaya a Inicio para registro">{{ __('Register') }}</a>
               </li>
