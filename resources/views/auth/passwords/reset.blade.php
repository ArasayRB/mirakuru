    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card bg-primary">
                <div class="card-header text-light border">
                  <div class="col justify-content-center">
                <img src="{{ asset('images/img/Login.png') }}" class="bg-primary mx-auto d-block py-2 px-2 ">
                <div class=" bg-primary"><h1 class="text-center text-light">{{ __('Reset Password') }}</h1>
                  </div>
                  </div>
                </div>
